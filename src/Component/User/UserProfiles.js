...
function UserProfiles() {
    ...
    useEffect(() => {
        const fetchDetails = async () => {
            try {
                const response = await axios.get(`http://localhost:4000/viewoneuser/${id}`);
                        ...
                        <div className="card-body">
                            <div className="row">
                                <div className="col-md-4 text-center">
                                    <img src="/path/to/profile/image.jpg" className="rounded-circle profile-img mb-3" alt="Profile" />
