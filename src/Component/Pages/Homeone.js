...
import img1 from '../Image/donation.jpeg'
...
around the globe.</p>
     <div class='container'>
      ...
      <a class="btn btn-primary text-center border-0" href="#" role="button" style={{width:'150px',borderRadius:'50px',backgroundColor:'yellow'}}>About us</a>
      </div>
     </div>
</div>
      </div>
